                ...
                <table id="table-data" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 50%">{{ $item->nama_jabatan }}</td>
                            <td style="width: 10%">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalheader">Jabatan</h5>
...
@section('script')
    <script>
        ...
        $('#btn-simpan').click(function (e) {
            ...
            if (dataId == '') {
                typePost = "POST"
                url = `${baseUrl}/api/w1/jabatan`
                console.log('post');
            } else {
                typePost = "PUT"
                url = `${baseUrl}/api/w1/jabatan/${dataId}`
                console.log('put');
            }
        ...
        $(document).on('click', '#btn-hapus', function() {
            ...
            let url = `${baseUrl}/api/w1/jabatan/` + _id;
            Swal.fire({
                title             : 'Anda Yakin?',
