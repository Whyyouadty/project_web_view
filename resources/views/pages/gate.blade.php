                ...
                <table id="table-data" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 20%">{{ $item->no_sesi }}</td>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#editItem', function () {
            ...
            $.get(`${baseUrl}/api/w1/gate/` + _id, function (res) {
                $('.modal-title' ).html ("Formulir Edit Data" );
                $('#btn-simpan'  ).val  ("edit-user"          );
                $('#nama-alert'  ).html ('                   ');
                $('#modal-data'  ).modal('show'               );
                $('#no_sesi'     ).val  (res.data.no_sesi);
        ...
        $('#btn-simpan').click(function (e) {
            ...
            if (dataId == '') {
                typePost = "POST"
                url = `${baseUrl}/api/w1/gate`
                console.log('post');
            } else {
                typePost = "PUT"
                url = `${baseUrl}/api/w1/gate/${dataId}`
                console.log('put');
            }
        ...
        $(document).on('click', '#btn-hapus', function() {
            ...
            let url = `${baseUrl}/api/w1/gate/` + _id;
            Swal.fire({
                title             : 'Anda Yakin?',
