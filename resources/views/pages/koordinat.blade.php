...
<div class="col-xl-12">
    <div class="card">
        <div class="card-header">
            <h4 class="mt--5" style="float: left">Data Koordinat</h4>
                    <button type="button"
                            id="createData"
                            data-toggle="modal"
                            data-target="#add"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalheader">Koordinat</h5>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#editItem', function () {
            ...
            $.get(`${baseUrl}/api/w1/koordinat/` + _id, function (res) {
        ...
        $('#btn-simpan').click(function (e) {
            ...
            if (dataId == '') {
                typePost = "POST"
                url = `${baseUrl}/api/w1/koordinat`
                console.log('post');
            } else {
                typePost = "PUT"
                url = `${baseUrl}/api/w1/koordinat/${dataId}`
                console.log('put');
            }
                ...
                error: function(result) {
                    ...
                    if (result.status = 422) {
                        ...
                        if (errorRes.length >= 1) {
                            $('#nama-alert').html(errorRes.data.titik_lintangy);
                        }
                    } else {
        ...
        $(document).on('click', '#btn-hapus', function() {
            ...
            let url = `${baseUrl}/api/w1/koordinat/` + _id;
            Swal.fire({
                title             : 'Anda Yakin?',
